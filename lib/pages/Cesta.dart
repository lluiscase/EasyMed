      ...
      children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Image.network(height: 125, imgs[index]),
                      ),
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(nome[index], style: TextStyle(fontSize: 14, fontWeight: FontWeight.w500)),
                                Text('R\$' + preco[index], style: TextStyle(color: Color(0xff16697A), fontWeight: FontWeight.w500, fontSize: 19)),
                              ],
                            ),
                          ),
                          Padding(
        ...
        SizedBox(
          ...
          child: TextButton(
            ...
            child: Text('Confirmar pedido', style: TextStyle(color: Colors.white, fontSize: 17)),
  ...
  Widget buildStateC() {
    return Column(
      ...
      children: [
                      ...
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Expanded(child: Column(
                              ...
                              children: [
                                ...
                                Text(nome[index], style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
                          ...
                          Padding(
                            ...
                            child: Text('R\$' + preco[index], style: TextStyle(color: Color(0xff16697A), fontWeight: FontWeight.w500, fontSize: 19)),
                          ),
                        ],
                      ),
                    ],
        ...
        Text('Total da compra: R\$' + total, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Container(
            margin: EdgeInsets.all(5),
            child: Text('Lembre-se de levar um documento com foto e número de identificação para a retirada do produto.', style: TextStyle(fontSize: 12)),
          ),
        )
      ],
    );
