...
String geradorQr() {
  ...
  return List<String>.generate(8, (index) => abcd[r.nextInt(62)]).join();
}
...
class CestaPageState extends State<CestaPage> {
  ...
  Future<void> addProduto() async {
    ...
    setState(() {
      ...
      this.imgs = imgatual;
      item = List<int>.filled(nome.length, 1);
    });
  }
  ...
  Future<void> carregar() async {
    ...
    try {
      ...
      setState(() {
        ...
        preco = precoatual;
        imgs = imgatual;
        item = List<int>.filled(nomesatual.length,
            1); // Garantindo que 'item' tenha o mesmo tamanho que 'nome'
      });
    } catch (e) {
      await prefs.clear();
    }
  ...
  Widget buildStateC() {
    return Column(
      ...
      children: [
        Text(
          'Oba!',
          style: TextStyle(fontSize: 16, color: Color(0xff16697a)),
        ),
        Text(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.only(top: 30, left: 115),
                              child: Text(
                                'R\$' + preco[index],
                                style: TextStyle(
                                    color: Color(0xff16697A),
        ...
        Text(
          ...
          style: TextStyle(fontSize: 16, color: Color(0xffFC444C)),
        ),
      ],
    );
  }
