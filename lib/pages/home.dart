...
import 'package:flutterguys/pages/produtos.dart' as proodutos;
        ...
        switch (index) {
          ...
          case 1:
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => localizacao.LocalizacaoRuas()));
            break;
          case 2:
            Navigator.push(
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => proodutos.ProdutosPage(
                                    desc: item.descricao,
                                    nome: item.nome,
                                    prec: item.preco,
                                    img: item.foto)));
                        ...
                        return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          proodutos.ProdutosPage(
                                              desc: snapshot.data![index]
                                                  .produtos[index].descricao,
                                              nome: snapshot.data![index]
                                                  .produtos[index].nome,
                                              prec: snapshot.data![index]
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Image.network(
                                      ...
                                      snapshot
                                          .data![index].produtos[index].foto,
                                      height: 65,
                                      fit: BoxFit.contain,
                                      loadingBuilder:
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      snapshot
                                          .data![index].produtos[index].nome,
