...
import 'package:flutterguys/pages/homePrincipal/telaEspec.dart';
...
class Categoria {
  ...
  factory Categoria.fromJson(Map<String, dynamic> json) {
    ...
    List<Produtos> produtos = produtoList
        ...
        [];
    return Categoria(
        nome: json['nome'], produtos: produtos, photo: json['photo'] ?? '');
  }
}
              ...
              return GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => telaEspec(
                                  categoria: snapshot.data![index].nome,
                                  state: 'Ver mais',
                                  nome: '',
                                  prec: '',
                                  desc: '',
